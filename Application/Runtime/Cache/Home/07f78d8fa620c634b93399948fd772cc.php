<?php if (!defined('THINK_PATH')) exit();?><table id="Kp_dg"></table>
...
<div id="Kp_Toolbar">
	...
	<input id="s_course" name="s_course" style="width:100px" class="easyui-combobox"
		data-options="    
			...
			textField: 'name',
			editable: false,
			url: 'http://localhost/zyyj/index.php/Home/Knowledgepoint/Kp_get_course_options',    
			onSelect: function(rec){
				var url = 'http://localhost/zyyj/index.php/Home/Knowledgepoint/Kp_get_chapter_options?c_id='+rec.course_id;
	...
	<input id="s_chapter" name="s_chapter" style="width:100px" class="easyui-combobox"
		data-options="
			...
			textField:'name',
			editable: false,
			url: 'http://localhost/zyyj/index.php/Home/Knowledgepoint/Kp_get_null_option'"
		>
	</input>
	<span>要求:</span>
	<input id="s_require" name="s_require" style="width:100px" class="easyui-combobox"
		url="http://localhost/zyyj/index.php/Home/Knowledgepoint/Kp_get_require_id_options"
	...
	<form id="Kp_fm" method="post">
		...
		<div class="fitem">
			...
			<input id="rquire" class="easyui-combobox" name="require_name"
				data-options="valueField:'require_id',textField:'name',url:'http://localhost/zyyj/index.php/Home/Knowledgepoint/Kp_get_require_id_options'"
...
<div id="Kp_upload" class="easyui-dialog" closed="true" buttons="#Kp_upload-buttons" style="width:330px;height:230px">
	<div class="fitem">
		...
		<div class="fiten">
			<label>模板:</label>
			<a href="http://localhost/zyyj/source/知识点导入模板.xlsx"><font color="blue">下载</font></a>
		</div>
		<br>
		<div class="fitem">
			<label>所属的科目:</label>
...
$('#Kp_dg').datagrid({
    url:'http://localhost/zyyj/index.php/Home/Knowledgepoint/Knowledgepoint_get_knowledgepoint',
    columns:[[
...
function Knowledgepoint_SearchAll(){
	$('#Kp_dg').datagrid('load',{});
	var url = 'http://localhost/zyyj/index.php/Home/Knowledgepoint/Kp_get_null_option';
//	$('#s_chapter').combobox('clear');
	Searchbox_clear();
	$('#s_chapter').combobox('reload', url);
}
...
function saveKnowledgepoint(){
	$('#Kp_fm').form('submit',{
		url: 'http://localhost/zyyj/index.php/Home/Knowledgepoint/Knowledgepoint_save',
		onSubmit: function(){
...
function uploadFile(){
	$('#upload_fm').form('submit',{
		url: 'http://localhost/zyyj/index.php/Home/Knowledgepoint/upload_excel',
		onSubmit: function(){
			return $(this).form('validate');
		},
		success: function(result){
