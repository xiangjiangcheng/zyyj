...
<script type="text/javascript">
      var classurl =  'http://localhost/zyyj/index.php/Home/Tao/Tao_GetClass';
	var geturl='<?php echo U('CreditManage_GetInfo');?>';
      var getexcel = 'http://localhost/zyyj/index.php/Home/CreditManage/CreditManage_GetInfo?';
</script>
<script type="text/javascript" src="http://localhost/zyyj/source/js/CreditManage_CreditManage.js" ></script>
<!--这里是积分排行榜-->
