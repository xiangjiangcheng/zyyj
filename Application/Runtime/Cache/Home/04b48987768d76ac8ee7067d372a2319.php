<?php if (!defined('THINK_PATH')) exit();?>﻿<table id="Mdg" class="easyui-datagrid" style="width:100%;height:100%"
	url='http://localhost/zyyj/index.php/Home/Major/Major_get_majors'
	toolbar="#Mtoolbar"
	rownumbers="true"
	fitColumns="true" 
	fit="true"
...
<script type="text/javascript">
	...
	function saveMajor(){
		$('#Mfm').form('submit',{
			url: 'http://localhost/zyyj/index.php/Home/Major/Major_save_major',
			onSubmit: function(){
