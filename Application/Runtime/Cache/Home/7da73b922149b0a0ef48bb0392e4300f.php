...
<script type="text/javascript">
	function sub(){
		...
		$.ajax({
				...
				cache : false,
				type : 'get',
				url : 'http://localhost/zyyj/index.php/Home/Menu/Menu_menu_to_post',
	...
	$(function () {
		$('#role').tree({ 
			url : 'http://localhost/zyyj/index.php/Home/Menu/Menu_get_post', 
			checkbox:true,
			...
			onSelect : function(node){
				...
				$('#menu').tree({ 
					url : 'http://localhost/zyyj/index.php/Home/Menu/Menu_get_post_menu?post_id='+node.id, 
					checkbox:true,
					onLoadSuccess : function (node, data) {
						if (data) {
							$(data).each(function (index, value) {
