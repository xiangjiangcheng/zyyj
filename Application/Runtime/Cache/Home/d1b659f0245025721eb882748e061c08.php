<?php if (!defined('THINK_PATH')) exit();?><script type="text/javascript" src="http://localhost/zyyj/source/js/Question.js"></script>
...
<div id="question_imp" name="question_imp" title="题目导入" style="width:400px;height:200px;" hidden="true">
	<form name="imp_question" id="imp_question" enctype="multipart/form-data" method="post">
		<table>
			<tr>
				<td align="right">模板：</td><td><a href="http://localhost/zyyj/source/题目导入模板.xlsx"><font color="blue">点击下载</font></a></td>
			</tr>
			<tr>
