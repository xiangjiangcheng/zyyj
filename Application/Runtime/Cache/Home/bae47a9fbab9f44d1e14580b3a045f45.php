<?php if (!defined('THINK_PATH')) exit();?><script type="text/javascript" src="http://localhost/zyyj/source/js/ExamLevel_ExamLevel_list.js" ></script>
<link rel="stylesheet" type="text/css" href="http://localhost/zyyj/source/css/Class_Class_list.css" />
    ...
    <table id="exam_level_datagrid" class="easyui-datagrid" style="width:auto;"
        url="http://localhost/zyyj/index.php/Home/ExamLevel/ExamLevel_list_show" toolbar="#exam_level_tb"
        ...
        <div id="exam_level_tb" style="padding:3px">
            ...
            url="http://localhost/zyyj/index.php/Home/ExamLevel/ExamLevel_getProgramme"
            ...
            <div id="eltool" style="height: 5%">
                ...
                <a href="#" id="exam_level_update" class="easyui-linkbutton" iconcls="icon-edit"
                    onclick="editExamLevel('http://localhost/zyyj/index.php/Home/ExamLevel/ExamLevel_getInfo')" plain="true">修改</a>
                <!-- <a href="#" id="exam_level_delete" class="easyui-linkbutton" onclick="delExamLevel('http://localhost/zyyj/index.php/Home/ExamLevel/ExamLevel_delete')" iconcls="icon-remove" plain="true">删除</a> -->
            </div>
        </div>
        <thead>
            <tr>
...
<div id="exam_level_dlg-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="saveExamLevel('http://localhost/zyyj/index.php/Home/ExamLevel/ExamLevel_add')" iconcls="icon-save">保存</a>
