<script type="text/javascript">
	var JErule = '{:U('CreditManage/CreditManage_GetRule')}';
	var Updturl = '{:U('CreditManage/CreditManage_UpdateRule')}';
</script>
<link rel="stylesheet" href="__SITE__source/css/Grade_Manage.css">
<script type="text/javascript" src="__SITE__source/js/ExchangeRule.js"></script>
<style type="text/css">
	.textbox{
		height: 20px;
		margin:0;
...
<div id='Jtool' style="padding:0px">
	<span>
		...
		<a class="easyui-linkbutton" iconCls='icon-remove' plain='true' id='J_remove' onclick="JRule_delete('{:U('CreditManage_DeletRule')}');">删除</a>
