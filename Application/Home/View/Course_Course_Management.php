<table id="Course_dg" class="easyui-treegrid" style="width:100%;height:100%"
		url="__SITE__index.php/Home/Course/Course_get_Courses"
	...
	<form id="Course_fm" method="post" enctype="multipart/form-data">
		<div class="fitem">
			...
			<input id="cc" class="easyui-combobox" name="_parentId"
				data-options="valueField:'parent_id',textField:'name',url:'__SITE__index.php/Home/Course/Course_get_parent_course'" 
...
<script type="text/javascript" language="javascript">
	...
	function saveCourse(){
		$('#Course_fm').form('submit', {
			url:'__SITE__index.php/Home/Course/Course_save_course',
			onSubmit:function(){
	...
	function photo_formatter(val,row){
		val = "<button onclick=\"showImage('__SITE__Uploads/"+val+"')\">查看</button>";
		return val;
	}
