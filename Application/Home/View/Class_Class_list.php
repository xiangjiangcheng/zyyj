<script type="text/javascript" src="__SITE__source/js/Class_Class_list.js" ></script>
<link rel="stylesheet" type="text/css" href="__SITE__source/css/Class_Class_list.css" />
    ...
    <table id="c_datagrid" class="easyui-datagrid" style="width:auto;"
        url="__SITE__index.php/Home/Class/Class_list_show" toolbar="#tb"
        ...
        <div id="tb" style="padding:3px">
            ...
            <a href="#" class="easyui-linkbutton" iconcls="icon-edit"
                onclick="editClass('__SITE__index.php/Home/Class/Class_getInfo')" plain="true">修改</a>
            <a href="#" class="easyui-linkbutton" onclick="delClass('__SITE__index.php/Home/Class/Class_delete')" iconcls="icon-remove" plain="true">删除</a>
        </div>
        <thead>
            <tr>
...
<div id="class_dlg-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="saveClass('__SITE__index.php/Home/Class/Class_add')" iconcls="icon-save">保存</a>
