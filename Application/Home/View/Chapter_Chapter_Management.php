...
<div id="Chapter_Toolbar">
	...
	<input id="Ch_s_course" name="Ch_s_course" style="width:100px" class="easyui-combobox"
		url="__SITE__index.php/Home/Chapter/Chapter_get_course_options"
	...
	<form id="Chapter_fm" method="post">
		...
		<div class="fitem">
			...
			<input class="easyui-combobox" name="course_name"
				data-options="valueField:'course_id',textField:'name',url:'__SITE__index.php/Home/Chapter/Chapter_get_course_options'" 
...
<div id="Chapter_upload" class="easyui-dialog" closed="true" buttons="#Chapter_upload-buttons" style="width:300px;height:210px">
	<div class="fitem">
		...
		<div class="fiten">
			<label>模板:</label>
			<a href="__SITE__source/章节导入模板.xlsx"><font color="blue">下载</font></a>
		</div>
		<br>
		<div class="fitem">
			<label>所属的科目:</label>
...
$('#Chapter_dg').datagrid({
    url:'__SITE__index.php/Home/Chapter/Chapter_get_chapter',
    columns:[[
...
function saveChapter(){
	$('#Chapter_fm').form('submit',{
		url: '__SITE__index.php/Home/Chapter/Chapter_save',
		onSubmit: function(){
...
function uploadFile(){
	$('#upload_fm').form('submit',{
		url: '__SITE__index.php/Home/Chapter/upload_excel',
		onSubmit: function(){
			return $(this).form('validate');
		},
		success: function(result){
