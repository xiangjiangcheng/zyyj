<link rel="stylesheet" type="text/css" href="__SITE__easyui/demo/demo.css" />
<script type="text/javascript" src="__SITE__source/js/student_list.js"></script>
<!-- url='{:U("Home/Student/Student_getAllStudent2","","")}' -->
<!-- url="__SITE__index.php/Home/Student/Student_getAllStudent2" -->
<style type="text/css">
	.sitem{
		margin-left: 10px;
	}
...
<!-- 存放后台传过来的学院id -->
<input id="college_id" name="college_id" value={$data.college_id} type="hidden"> 
...
<form id="student_import" name="student_import" enctype="multipart/form-data" method="post" style="margin:0;padding:5px 0 0 25px;color:#333;">
	<input id="college_id_panduanimport" name="college_pandhuanimport" value={$data.college_id} type="hidden"> 
	<p>模板：<a href="__SITE__source/学生导入模板.xlsx"><font color="blue">点击下载</font></a></p>
