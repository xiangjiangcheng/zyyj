<script type="text/javascript" src="__SITE__source/js/Programme_Programme_list.js" ></script>
<link rel="stylesheet" type="text/css" href="__SITE__source/css/Class_Class_list.css" />
    ...
    <table id="pro_datagrid" class="easyui-datagrid" style="width:auto;"
        url="__SITE__index.php/Home/Programme/Programme_list_show" toolbar="#programme_tb"
        ...
        <div id="programme_tb" style="padding:3px">
            ...
            <a href="#" class="easyui-linkbutton" iconcls="icon-edit"
                onclick="editProgramme('__SITE__index.php/Home/Programme/Programme_getInfo')" plain="true">修改</a>
            <a href="#" class="easyui-linkbutton" onclick="delProgramme('__SITE__index.php/Home/Programme/Programme_delete')" iconcls="icon-remove" plain="true">删除</a>
        </div>
        <thead>
            <tr>
...
<div id="programme_dlg-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="saveProgramme('__SITE__index.php/Home/Programme/Programme_add')" iconcls="icon-save">保存</a>
...
<script type="text/javascript" charset="UTF-8">
 $(function(){
    ...
    //                 cascade('__SITE__index.php/Home/Class/Class_getGrade','s_major','s_grade');
    //         }
    // });
    // $('#major').combobox({
    //         // url:"getClose.do",
    ...
    //         // width:130,
    //         onSelect:function(record){
    //                 cascade('__SITE__index.php/Home/Class/Class_getGrade','major','grade');
    //         }
    // });
