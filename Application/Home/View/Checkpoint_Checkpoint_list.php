<script type="text/javascript" src="__SITE__source/js/Checkpoint_Checkpoint_list.js" ></script>
<link rel="stylesheet" type="text/css" href="__SITE__source/css/Class_Class_list.css" />
    ...
    <table id="checkpoint_datagrid" class="easyui-datagrid" style="width:auto;"
        url="__SITE__index.php/Home/Checkpoint/Checkpoint_list_show" toolbar="#checkpoint_tb"
        ...
        <div id="checkpoint_tb" style="padding:3px">
            ...
            url="__SITE__index.php/Home/Checkpoint/Checkpoint_getProgramme"
            ...
            <div id="optools" style="height: 5%">
                ...
                <a href="#" id="checkpoint_update" class="easyui-linkbutton" iconcls="icon-edit"
                    onclick="editCheckpoint('__SITE__index.php/Home/Checkpoint/Checkpoint_getInfo')" plain="true">修改</a>
                <a href="#" id="checkpoint_delete" class="easyui-linkbutton" onclick="delCheckpoint('__SITE__index.php/Home/Checkpoint/Checkpoint_delete')" iconcls="icon-remove" plain="true">删除</a>
            </div>
        </div>
        <thead>
            <tr>
...
<div id="checkpoint_dlg-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="saveCheckpoint('__SITE__index.php/Home/Checkpoint/Checkpoint_add')" iconcls="icon-save">保存</a>
