<script type="text/javascript" src="__SITE__source/js/ExamProgram_ExamProgram_list.js" ></script>
<link rel="stylesheet" type="text/css" href="__SITE__source/css/Class_Class_list.css" />
    ...
    <table id="examprogram_datagrid" class="easyui-datagrid" style="width:auto;"
        url="__SITE__index.php/Home/ExamProgram/ExamProgram_list_show" toolbar="#examprogram_tb"
        ...
        <div id="examprogram_tb" style="padding:3px">
            ...
            <a href="#" class="easyui-linkbutton" iconcls="icon-edit"
                onclick="editExamProgram('__SITE__index.php/Home/ExamProgram/ExamProgram_getInfo')" plain="true">修改</a>
            <a href="#" class="easyui-linkbutton" onclick="delExamProgram('__SITE__index.php/Home/ExamProgram/ExamProgram_delete')" iconcls="icon-remove" plain="true">删除</a>
        </div>
        <thead>
            <tr>
...
<div id="examprogram_dlg-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="saveExamProgram('__SITE__index.php/Home/ExamProgram/ExamProgram_add')" iconcls="icon-save">保存</a>
